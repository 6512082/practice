...
class ConnectionManagerStubAdapter
 ...
 public:
    ...
    */
    virtual void fireContextAddedEvent(const std::string &_ContextID, const ::v0::DCU::Telephony::CommonTypes::ConnectionContextItem &_item) = 0;
    /**
...
{
public:
    typedef std::function<void (::v0::DCU::Telephony::CommonTypes::ContextError _error)>DeactivateAllReply_t;
    typedef std::function<void (::v0::DCU::Telephony::CommonTypes::AddContextError _error, std::string _ContextID)>AddContextReply_t;
    typedef std::function<void (::v0::DCU::Telephony::CommonTypes::RemoveContextError _error)>RemoveContextReply_t;
    typedef std::function<void (std::vector< ::v0::DCU::Telephony::CommonTypes::ConnectionContextItem > _items)>GetContextsReply_t;
    typedef std::function<void (::v0::DCU::Telephony::CommonTypes::GetContextError _error, ::v0::DCU::Telephony::CommonTypes::ConnectionContextItem _item)>GetContextReply_t;
    ...
    virtual void fireContextAddedEvent(const std::string &_ContextID, const ::v0::DCU::Telephony::CommonTypes::ConnectionContextItem &_item) {
