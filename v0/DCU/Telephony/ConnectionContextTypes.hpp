...
namespace std {
    ...
    template<>
    struct hash< ::v0::DCU::Telephony::ConnectionContextTypes::ContextError> {
        inline size_t operator()(const ::v0::DCU::Telephony::ConnectionContextTypes::ContextError& contextError) const {
            return static_cast< int32_t>(contextError);
        }
    };
    //Hash for AddContextError
    template<>
    struct hash< ::v0::DCU::Telephony::ConnectionContextTypes::AddContextError> {
        inline size_t operator()(const ::v0::DCU::Telephony::ConnectionContextTypes::AddContextError& addContextError) const {
            return static_cast< int32_t>(addContextError);
        }
    };
    //Hash for RemoveContextError
    template<>
    struct hash< ::v0::DCU::Telephony::ConnectionContextTypes::RemoveContextError> {
        inline size_t operator()(const ::v0::DCU::Telephony::ConnectionContextTypes::RemoveContextError& removeContextError) const {
            return static_cast< int32_t>(removeContextError);
        }
    };
    //Hash for ContextStatus
    template<>
    struct hash< ::v0::DCU::Telephony::ConnectionContextTypes::ContextStatus> {
        inline size_t operator()(const ::v0::DCU::Telephony::ConnectionContextTypes::ContextStatus& contextStatus) const {
            return static_cast< int32_t>(contextStatus);
        }
    };
    //Hash for GetContextError
    template<>
    struct hash< ::v0::DCU::Telephony::ConnectionContextTypes::GetContextError> {
        inline size_t operator()(const ::v0::DCU::Telephony::ConnectionContextTypes::GetContextError& getContextError) const {
            return static_cast< int32_t>(getContextError);
        }
    };
    //Hash for DeactivateReason
    template<>
    struct hash< ::v0::DCU::Telephony::ConnectionContextTypes::DeactivateReason> {
        inline size_t operator()(const ::v0::DCU::Telephony::ConnectionContextTypes::DeactivateReason& deactivateReason) const {
