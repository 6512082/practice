...
public:
     ...
     * will be set.
     */
    virtual void DeactivateAll(CommonAPI::CallStatus &_internalCallStatus, ::v0::DCU::Telephony::CommonTypes::ContextError &_error, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void AddContext(const std::string &_APN, const std::string &_IP_Protocol, CommonAPI::CallStatus &_internalCallStatus, ::v0::DCU::Telephony::CommonTypes::AddContextError &_error, std::string &_ContextID, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All const parameters are input parameters to this method.
     ...
     * will be set.
     */
    virtual void RemoveContext(const std::string &_ContextID, CommonAPI::CallStatus &_internalCallStatus, ::v0::DCU::Telephony::CommonTypes::RemoveContextError &_error, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void GetContexts(CommonAPI::CallStatus &_internalCallStatus, std::vector< ::v0::DCU::Telephony::CommonTypes::ConnectionContextItem > &_items, const CommonAPI::CallInfo *_info = nullptr);
    /**
    ...
    * All non-const parameters will be filled with the returned values.
     ...
     * will be set.
     */
    virtual void GetContext(const std::string &_ContextID, CommonAPI::CallStatus &_internalCallStatus, ::v0::DCU::Telephony::CommonTypes::GetContextError &_error, ::v0::DCU::Telephony::CommonTypes::ConnectionContextItem &_item, const CommonAPI::CallInfo *_info = nullptr);
    /**
 ...
 */
template <typename ... _AttributeExtensions>
void ConnectionManagerProxy<_AttributeExtensions...>::DeactivateAll(CommonAPI::CallStatus &_internalCallStatus, ::v0::DCU::Telephony::CommonTypes::ContextError &_error, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void ConnectionManagerProxy<_AttributeExtensions...>::AddContext(const std::string &_APN, const std::string &_IP_Protocol, CommonAPI::CallStatus &_internalCallStatus, ::v0::DCU::Telephony::CommonTypes::AddContextError &_error, std::string &_ContextID, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void ConnectionManagerProxy<_AttributeExtensions...>::RemoveContext(const std::string &_ContextID, CommonAPI::CallStatus &_internalCallStatus, ::v0::DCU::Telephony::CommonTypes::RemoveContextError &_error, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void ConnectionManagerProxy<_AttributeExtensions...>::GetContexts(CommonAPI::CallStatus &_internalCallStatus, std::vector< ::v0::DCU::Telephony::CommonTypes::ConnectionContextItem > &_items, const CommonAPI::CallInfo *_info) {
 ...
 */
template <typename ... _AttributeExtensions>
void ConnectionManagerProxy<_AttributeExtensions...>::GetContext(const std::string &_ContextID, CommonAPI::CallStatus &_internalCallStatus, ::v0::DCU::Telephony::CommonTypes::GetContextError &_error, ::v0::DCU::Telephony::CommonTypes::ConnectionContextItem &_item, const CommonAPI::CallInfo *_info) {
